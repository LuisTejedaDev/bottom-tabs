...
export default ({item, accessibilityState, onPress}) => {
    ...
    return(
        ...
        >
            ...
            >
                <Animated.View style={[{width: 50, height: 50, borderRadius: 100, position: 'absolute', backgroundColor: '#0792b3'}, scaleStyles]}/>
                <Material name={item.icon} color={accessibilityState.selected ? '#fff' : '#0792b3'} size={22}/>
            </Animated.View>
